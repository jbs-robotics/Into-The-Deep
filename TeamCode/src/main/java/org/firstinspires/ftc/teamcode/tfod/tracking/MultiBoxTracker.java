...
package org.firstinspires.ftc.teamcode.tfod.tracking;
...
import com.google.ftcresearch.tfod.util.BorderedText;
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      final RectF trackedPos =
          (objectTracker != null)
              ...
              : new RectF(recognition.location);
      recognitions.add(
          new Recognition(recognition.title, recognition.detectionConfidence, trackedPos));
    }
